...
SET "repo_id"=$1,"flavor"=$2,"platform"=$3,"ref"=$4,"version"=$5,"services"=$6,"stages"=$7,"steps"=$8,"templates"=$9,"data"=$10
WHERE "id" = $11`).
		WithArgs(1, nil, nil, "refs/heads/master", "1", false, false, false, false, AnyArgument{}, 1).
